...
public interface INetBankingController {
    ...
    public String issueDebitCard(String accNo, int pin);
    
    public void transferFund(String from, String to, double transferAmount) throws AccountNotFoundException, InsufficientAmountException;
